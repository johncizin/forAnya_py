...
# Quick Description:
- File: <a href = "https://github.com/johncizin/forAnya_py/blob/main/src/basicNotion.py" target="_blank" rel="noopener noreferrer"> basicNotion.py </a>
...
- File: <a href = "https://github.com/johncizin/forAnya_py/blob/main/src/anotherNotion_json.py" target="_blank" rel="noopener noreferre"> anotherNotion_json.py
    - This python file reads data from an existing <a href="https://github.com/johncizin/forAnya_py/blob/main/src/pseudoOutput.json" target="_blank" rel="noopener noreferrer"> JSON file included in this repo. </a> **JSON (JavaScript Object Notion) is a human-readable text format commonly used when exhanging data, e.g. calling an API it returns a JSON formatted data. Just think of it as a specific language that some API's use to talk to each other.**
