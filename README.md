...
- [Walkthrough](#-walkthrough)
    ...
    - [anotherNotion_json.py](#anothernotion_jsonpy)
...
# 🟢 Walkthrough
## <a href="https://github.com/johncizin/forAnya_py/blob/main/src/basicNotion.py"> basicNotion.py </a>
...
## <a href="https://github.com/johncizin/forAnya_py/blob/main/src/anotherNotion_json.py"> anotherNotion_json.py </a>
### Data Structure of File (JSON):
<p align="center">
    <img src="./imgs/basicNotion_DataModel.png" alt="basicNotion_DataModel Image"> 
</p>
...
In JSON the structure looks like:
```JSON
{
    "userID": "13456767",
    "page": {
